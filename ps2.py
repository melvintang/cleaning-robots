...
def runSimulation(num_robots, speed, width, height, min_coverage, num_trials,
    ...
    # for each trial in stated number of trials
    for trial in range(num_trials):
        #Prepare a list of robots.
        botList = []
        #Append to botList a certain number of times = num_robots
        ...
        while (1.0*room.getNumCleanedTiles()/room.getNumTiles()) <= min_coverage:
            ...
            # After all robots have moved and cleaned at the same time, 1 time-step has passed.
            steps += 1

        # After each trial, append the total time-steps to the list of times
        trialsList.append(steps)
        #anim.done()

    # After all the trials, find the mean time to clean the room per trial
...
class RandomWalkRobot(Robot):
    ...
    def updatePositionAndClean(self):
        ...
        # irregardless of whether the robot hits the room or not, always chooses random direction.
        self.direction = random.randint(0, 359)


def showPlot1(title, x_label, y_label):
    """
    To plot a list of time steps vs a list of number of robots. 2 plots for 2 types of robots.
    Inputs: strings
    """
    num_robot_range = range(1, 11)
    # Initialize for 2 plots
    times1 = []
    times2 = []
    # for each certain number of robots
    for num_robots in num_robot_range:
        print "Plotting", num_robots, "robots..."
        # find the average time steps and append to times1 and times2 respectively.
        times1.append(runSimulation(num_robots, 1.0, 20, 20, 0.8, 20, StandardRobot))
        times2.append(runSimulation(num_robots, 1.0, 20, 20, 0.8, 20, RandomWalkRobot))
    # You will have 2 corresponding lists: times1 and times2 vs num_robot_range
    # Do plotting for each on the same figure.
...
def showPlot2(title, x_label, y_label):
    """
    To plot time for 2 robots to clean 80% of a room vs list of different shaped rooms.
    Inputs: strings
    """
    aspect_ratios = []
    times1 = []
    ...
    # 2 corresponding lists: times1 and times2 vs aspects ratios
